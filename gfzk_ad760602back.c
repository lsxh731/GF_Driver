...
#define AD760602_EIMD20_RESET	IMX_GPIO_NR(3, 20)
...
void ad760602_reset()
{
	...
	ret = -1;
	//printk("************************ %s\n", __FUNCTION__);
	if(gpio_request(AD760602_EIMD20_RESET, "ad760602_RESET"))
                pr_err("failed to request GPK1_0 for ad760602 reset control\n");
	gpio_direction_output(AD760602_EIMD20_RESET, 0);
    mdelay(3);

	gpio_set_value(AD760602_EIMD20_RESET, 0);
	ret = gpio_get_value(AD760602_EIMD20_RESET);
	printk("ad760602_reset AD760602_EIMD20_RESET = %d !\n",ret);
	mdelay(1);
    gpio_set_value(AD760602_EIMD20_RESET, 1);
	ret = gpio_get_value(AD760602_EIMD20_RESET);
    printk("ad760602_reset AD760602_EIMD20_RESET = %d !\n",ret);
	ndelay(80);      /* AD7606是高电平复位，要求最小脉宽50ns */
	gpio_set_value(AD760602_EIMD20_RESET, 0);
	ret = gpio_get_value(AD760602_EIMD20_RESET);
    printk("ad760602_reset AD760602_EIMD20_RESET = %d !\n",ret);
	
    gpio_free(AD760602_EIMD20_RESET);
}
...
static ssize_t
ad760602_write(struct file *filp, const char __user *buf,
